// src/pages/Admission/ApplyUpper.jsx
import { useNavigate } from "react-router-dom";
import heroImg from "../../assets/images/Admission-ApplyUpper-1.png";

export default function ApplyUpper() {
  const navigate = useNavigate();

  // ----- Timeline rows (per your screenshot) -----
  const timeline = [
    ...
    { step: "Admission Decision Notification", deadline: "February 13, 2026" },
    {
      step: "Enrollment Deadline for Admitted Families",
      deadline: "12:00 pm (ET) on March 12, 2026",
    },
  ];

  // ----- Process steps (mirrors layout/wording from screenshots) -----
  const process = [
    {
      ...
      body: (
        <>
          <p className="mb-4">
            ...
            financial assistance may request a fee waiver during the
            application. Apply{" "}
    ...
    },
    {
      ...
      body: (
        <p>
          ...
          family that would like to visit Marefat. Choose from a{" "}
  ...
  return (
    <main className="w-full bg-white">
      {/* ===== HERO (shifted DOWN via object-position so faces aren't cropped) ===== */}
      <section className="relative w-full h-[60vh] md:h-[78vh] overflow-hidden">
        <img
          src={heroImg}
          alt="Apply to Upper School — Marefat International High School"
          className="absolute inset-0 w-full h-full object-cover"
          style={{ objectPosition: "center 40%" }} // tweak 30–50% as needed
        />
      ...
      <section className="w-full bg-white">
        <div className="mx-auto max-w-[1200px] px-6 lg:px-10 py-14 lg:py-20 grid gap-10 lg:grid-cols-2 items-start">
          ...
          <div className="text-gray-700 text-[17px] leading-8">
            <p className="mb-6">
              We review a student’s application with attention to character,
              ...
              parents/guardians who will partner with us as we foster a more
              inclusive program.
            </p>
            <p className="mb-8">
      ...
      <section className="w-full bg-red-700 text-white">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-10 lg:py-14 text-center">
          <p className="font-serif text-3xl md:text-5xl leading-tight">
            Ready to Apply?{" "}
            <button
              onClick={() => navigate("/admission/apply/upper")}
